...
This section documents the key technical decisions made during development and the reasoning behind them.
...
* Strong TypeScript support with autogenerated types
* Clear schema definition and migrations
...
* Industry-standard hashing algorithm for passwords
* Built-in salting and adjustable cost factor
* Protects user credentials in case of database compromise

---

### 3. TypeScript Across Frontend and Backend
...
* Better developer experience with autocomplete and compile-time checks
